...
create table profesores(
    ...
    nombre_pila VARCHAR2(20) not null,
    activo VARCHAR2(1) not null,
    categoria VARCHAR2(4) not null,
    dedicacion VARCHAR2(3) not null,
    area VARCHAR2(3) not null,
    foreign key(area) references areas(codigo)
    on delete cascade	
);

create table asignaturas(
    siglas VARCHAR2(6) primary key,
    nombre VARCHAR2(40) not null,
    creditos smallint,
    curso smallint,
    anualidad VARCHAR2(1),
    clase VARCHAR2(1),
...
create table locales(
    ...
    situacion VARCHAR2(40)
);

create table grupos(
    curso VARCHAR2(1) not null,
...
create table docencia(
    ...
    siglas VARCHAR2(6) not null,
    profesor smallint not null,
    local VARCHAR2(5) not null,
    dia VARCHAR2(1),
    hora decimal(4,1),
    periodicidad smallint,
    foreign key (curso,clase,grupo) references  grupos(curso,clase,codigo)
	on delete cascade,
    foreign key(profesor) references profesores(codigo)
	on delete cascade,
    foreign key(local) references locales(codigo)
	on delete cascade,	
    foreign key(siglas) references asignaturas(siglas)
    on delete cascade	
  );
...
INSERT INTO PROFESORES VALUES (6,'Caiadas','Garcia','Andres',1,'AsN1','6 h','OEM');
...
INSERT INTO PROFESORES VALUES (14,'Giralt','Muina','Juan',1,'TEU','TC','LSI');
...
INSERT INTO PROFESORES VALUES (18,'Banega','Iranzo','Pascual',1,'TEU','TC','LSI');
...
INSERT INTO PROFESORES VALUES (25,'Munoz','Caro','Camelia',1,'TEU','TC','LSI');
INSERT INTO PROFESORES VALUES (26,'Nino','Ramos','Alfonso',1,'TEU','TC','LSI');
...
INSERT INTO PROFESORES VALUES (41,'Vinuela','Conejo','Urbano',1,'TEU','TC','FIS');
...
INSERT INTO PROFESORES VALUES (51,'Bustos','Moreno','Maria Arantzazu',1,'AsN1','6 h','LSI');
...
INSERT INTO ASIGNATURAS VALUES ('DES','Diseno y Explotacion de Sistemas',9,3,'A','O',2,1,2,5,187);
...
INSERT INTO ASIGNATURAS VALUES ('DFC','Diseno y Fabricacion por Computador',9,3,'A','P',2,1,1,5,101);
...
INSERT INTO ASIGNATURAS VALUES ('DSM','Diseno de Sistemas con Microprocesador',9,3,'','P',2,1,0,0,0);
INSERT INTO ASIGNATURAS VALUES ('PSe','Procesamiento de la Senal',9,3,'A','P',2,1,1,1,53);
...
INSERT INTO LOCALES VALUES ('I11','Despacho I11','0',3,'ITA','Planta Primera, izquierda');
INSERT INTO LOCALES VALUES ('I12','Despacho I12','0',1,'ITA','Planta Primera, derecha');
INSERT INTO LOCALES VALUES ('I31','Despacho I31','0',2,'ITA','Planta Tercera, izquierda');
